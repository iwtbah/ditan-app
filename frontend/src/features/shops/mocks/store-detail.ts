...
export const STORE_DETAIL_STORE: StoreDetailData = localizeMockData({
  name: "时光机复古杂货铺",
  rating: "4.8",
  price: "￥120/人",
...
export const STORE_DETAIL_DISHES: StoreDish[] = localizeMockData([
...
export const STORE_DETAIL_REVIEWS: StoreReview[] = localizeMockData([
...
export const STORE_DETAIL_SELECTED_NOTES: MasonryNoteData[] = localizeMockData([
...
export const STORE_DETAIL_ALL_NOTES: MasonryNoteData[] = localizeMockData([
