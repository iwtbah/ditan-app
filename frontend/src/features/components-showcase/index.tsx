...
import { CategoryTabs, FollowButton, PublishButton } from "./components/showcase-primitives";
...
export const ComponentsShowcaseFeature = () => {
...
export default ComponentsShowcaseFeature;
