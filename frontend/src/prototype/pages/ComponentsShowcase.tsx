      ...
      <div className="flex-1 overflow-y-auto p-5 pb-20 bg-white">
        ...
        <Section title="Interactive / PublishButton (发布)">
           <Variant name="Button / Publish / Primary">
              <PublishButton variant="primary" className="w-full py-3">发布笔记</PublishButton>
           </Variant>
           <Variant name="Button / Publish / Disabled">
              <PublishButton variant="primary" disabled={true} className="w-full py-3">发布笔记</PublishButton>
           </Variant>
        </Section>

        <Section title="Structure / CategoryTabs & Header">
           <Variant name="Header / Default">
              <div className="-mx-4 -my-4"><Header city="北京" placeholder="搜索你想去的探店..." /></div>
           </Variant>
           <Variant name="CategoryTabs / Default">
              <div className="-mx-4 -my-4 pt-4"><CategoryTabs tabs={["推荐", "附近", "美食", "咖啡", "玩乐"]} activeTab="推荐" /></div>
           </Variant>
        </Section>
