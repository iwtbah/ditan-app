...
import { StateContext, type AppState, type SubState } from '@/prototype/context/StateContext';

export function PrototypeWorkspaceLayout() {
  const [appState, setAppState] = useState<AppState>('Normal');
  const [subState, setSubState] = useState<SubState>('Normal');

  return (
    <StateContext.Provider value={{ appState, setAppState, subState, setSubState }}>
