...
import { AlertCircle, Image, Inbox, RefreshCw, User } from 'lucide-react';
...
export const ImagePlaceholder = ({
  ...
  <div
    className={`bg-gray-200 border border-dashed border-gray-400 flex items-center justify-center text-gray-400 relative overflow-hidden ${className}`}
  >
    <Image size={iconSize} />
    {children}
  </div>
...
export const ButtonPlaceholder = ({
  ...
  const baseClasses =
    'flex items-center justify-center rounded-md font-medium text-sm transition-colors';
...
export const ErrorState = ({
  ...
  <div className="flex flex-col items-center justify-center py-20 px-4 text-gray-500 w-full h-full min-h-[300px]">
    ...
    <ButtonPlaceholder
      variant="outline"
      onClick={onRetry}
      className="text-xs py-1.5 h-auto rounded-full bg-white px-5 shadow-sm border-gray-300"
    >
